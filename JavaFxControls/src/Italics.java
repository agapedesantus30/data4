 ...
 * 
 * 
 *          This class � This class describes Italics used to contain the
 *          BorderPane. It also contains the main method which starts the program.
 * 
 *          Purpose: Methods and attributes needed to create a BorderPane Italics
 *           class. Provides a description of characters along with images
 *
 */
public class Italics extends Projector {
	...
	protected BorderPane getPane() {
		...
		paneForCheckBoxes.setStyle("-fx-border-color: brown");
		paneForCheckBoxes.setStyle("-fx-border-width: 2px; -fx-border-color: brown");
